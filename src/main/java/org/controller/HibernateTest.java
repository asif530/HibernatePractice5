...
/*
* Many to Many with 2 additional table
* From UserDetails remove (mappedBy = "userDetails") to see these 2 table
* Here Songs_Aliens (Songs_sid, userDetails_userId) and Aliens_Songs (UserDetails_userId, Playlist_sid) are created.
* */
